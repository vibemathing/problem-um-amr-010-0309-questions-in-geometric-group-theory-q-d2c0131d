...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0309-questions-in-geometric-group-theory-q-d2c0131d",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0309-b148524f8b17",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0309"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Conjecture: for $n>1$, the set $$\\{(x_1,\\ldots,x_n)\\in F_n^n:x_1,\\ldots,x_n\\text{ is a basis of }F_n\\}$$ is not definable.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 3.9",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "81569547a261c9917d82fa65a064ea981fc74b843dd95f6cfa9048328cc59914"
}
```
